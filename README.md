...
| Bracket-delimited text commands (e.g. `[[pbas200]]`) | `EmbeddedCmd.c` | Not ported — depends on the unported `FrontEnd.c` tokenizer; see `docs/architecture.md` for a reference-verification blocker found in the compiled `lintalker-c` test harness |
...
"heroism", "editor", "itemize"). Remaining known gaps: no true
compound-noun splitting, no number/abbreviation expansion, no embedded
commands — see
