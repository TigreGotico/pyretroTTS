...
from pyretrotts._numbers import number_to_phonemes
from pyretrotts._phonemes import _Word_


def _decode(phons):
    from pyretrotts import _phonemes as P
...
def test_number_token_gets_kadj_pos():
    from pyretrotts._assembly import make_fe_word_token
    from pyretrotts._consts import kAdj
...
def test_frontend_tokenize_preserves_digit_tokens():
    from pyretrotts._frontend import tokenize
...
def test_digit_by_digit_reads_each_digit_separately():
    from pyretrotts._numbers import _ONES, digit_by_digit_phonemes
...
def test_nmbr_embedded_command_switches_to_digit_by_digit():
    from pyretrotts._numbers import digit_by_digit_phonemes, number_to_phonemes
...
def test_is_year_number():
    from pyretrotts._numbers import is_year_number
...
def test_year_to_phonemes_two_groups():
    from pyretrotts._numbers import _two_digit_phonemes, year_to_phonemes
...
def test_year_to_phonemes_oh_insertion():
    from pyretrotts._numbers import _OH, _two_digit_phonemes, year_to_phonemes
...
def test_year_to_phonemes_round_hundred():
    from pyretrotts._numbers import _HUNDRED, _two_digit_phonemes, year_to_phonemes
...
def test_number_token_reads_as_year_by_default():
    from pyretrotts._assembly import make_fe_word_token
    from pyretrotts._numbers import number_to_phonemes, year_to_phonemes
    ...
    from pyretrotts._numbers import digit_by_digit_phonemes
...
def test_tokenize_dollar_prefix_kept_as_digit_token():
    from pyretrotts._frontend import scan_tokens
...
def test_dollar_phonemes_plural_and_singular():
    from pyretrotts._numbers import _DOLLAR, dollar_phonemes, number_to_phonemes
...
def test_dollar_amount_reaches_word_token_end_to_end():
    from pyretrotts._numbers import dollar_phonemes, number_to_phonemes
...
def test_dollar_bypasses_year_detection():
    ...
    from pyretrotts._assembly import make_fe_word_token
    from pyretrotts._numbers import dollar_phonemes, year_to_phonemes
...
def test_cent_phonemes_plural_and_singular():
    from pyretrotts._numbers import _CENT, cent_phonemes, number_to_phonemes
...
def test_dollar_and_cents_reaches_word_tokens_end_to_end():
    from pyretrotts._numbers import cent_phonemes, dollar_phonemes
...
def test_clock_phonemes_normal_oh_and_oclock():
    from pyretrotts._numbers import _CLOCK, _OH, _two_digit_phonemes, clock_phonemes
...
def test_clock_time_reaches_word_tokens_end_to_end():
    from pyretrotts._numbers import clock_phonemes, number_to_phonemes
