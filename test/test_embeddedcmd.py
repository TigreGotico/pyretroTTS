...
def test_scan_bracket_commands_strips_and_parses_pbas():
    ...
    clean, cmds, _emph, _silences, _pos, _rates, _final_rate, _nmbr = scan_bracket_commands("[[pbas300]]hello world")
...
def test_scan_bracket_commands_word_index_tracks_preceding_words():
    ...
    clean, cmds, _emph, _silences, _pos, _rates, _final_rate, _nmbr = scan_bracket_commands("hello [[volm50]] world")
    assert clean == "hello  world"
...
def test_scan_bracket_commands_relative_sign():
    ...
    clean, cmds, _emph, _silences, _pos, _rates, _final_rate, _nmbr = scan_bracket_commands("[[pbas+50]]hello")
...
def test_scan_bracket_commands_unrecognized_keyword_left_untouched():
    ...
    clean, cmds, _emph, _silences, _pos, _rates, _final_rate, _nmbr = scan_bracket_commands("[[bogus123]]hello")
...
def test_scan_bracket_commands_cmnt_and_vers_are_stripped_noops():
    ...
    clean, cmds, emph, _silences, _pos, _rates, _final_rate, _nmbr = scan_bracket_commands("[[cmnt this is ignored]]hello")
    assert clean == "hello"
    assert cmds == [] and emph == {}

    clean, cmds, emph, _silences, _pos, _rates, _final_rate, _nmbr = scan_bracket_commands("[[vers65536]]hello")
    assert clean == "hello"
    assert cmds == [] and emph == {}
...
def test_scan_bracket_commands_dlim_changes_subsequent_delimiters():
    ...
    clean, cmds, _emph, _silences, _pos, _rates, _final_rate, _nmbr = scan_bracket_commands("[[dlim60 62]]<pbas60>hello")
    assert clean == "hello"
...
def test_scan_bracket_commands_emph():
    ...
    clean, cmds, emph, _silences, _pos, _rates, _final_rate, _nmbr = scan_bracket_commands("[[emph+]]hello world")
    assert clean == "hello world"
    assert cmds == []
    assert emph == {0: "emphasize"}

    clean, cmds, emph, _silences, _pos, _rates, _final_rate, _nmbr = scan_bracket_commands("hello [[emph-]]world")
    assert clean == "hello world"
...
def test_scan_bracket_commands_slnc():
    ...
    clean, cmds, emph, silences, _pos, _rates, _final_rate, _nmbr = scan_bracket_commands("hello [[slnc500]]world")
    assert clean == "hello world"
...
def test_scan_bracket_commands_rset():
    ...
    clean, cmds, emph, silences, _pos, _rates, _final_rate, _nmbr = scan_bracket_commands("[[rset0]]hello")
    assert clean == "hello"
    assert cmds == [(0, C_reset, 0)]

    clean, cmds, emph, silences, _pos, _rates, _final_rate, _nmbr = scan_bracket_commands("[[rset5]]hello")
    assert clean == "hello"
    assert cmds == []
...
def test_scan_bracket_commands_sync():
    ...
    clean, cmds, emph, silences, _pos, _rates, _final_rate, _nmbr = scan_bracket_commands("[[sync12345]]hello")
    assert clean == "hello"
...
def test_scan_bracket_commands_xtnd_wpos():
    ...
    clean, cmds, emph, silences, pos, _rates, _final_rate, _nmbr = scan_bracket_commands(
...
def test_scan_bracket_commands_rate():
    ...
    clean, cmds, emph, silences, pos, rates, final_rate, _nmbr = scan_bracket_commands(
        "hello [[rate240]]world"
    )
    assert clean == "hello world"
    assert rates == {1: 240}
    ...
    clean, cmds, emph, silences, pos, rates, final_rate, _nmbr = scan_bracket_commands("hello")
